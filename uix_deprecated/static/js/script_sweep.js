...
async function sweep() {
    try {
        ...
        const sessionPath = sessionData.session_path;  // Replace projectDirectoryPath with session path

        // Ensure uniqueSweepName is initialized
        var uniqueSweepName = new Date().getTime();
        var outputPath = sessionPath + "/sweep/" + uniqueSweepName;  // Use sessionPath instead of projectDirectoryPath
        ...
        const ADFPath = sessionPath + "/" + projectName + ".json";  // Use sessionPath instead of projectDirectoryPath
        ...
        console.error("Error during sweep process:", error);
    }
}
